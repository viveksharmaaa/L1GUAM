...
DataFname       = 'C:\Users\bullo\OneDrive - University of Illinois - Urbana\Research\MATLAB_GUAM\Exec_Scripts\Hover2CruiseSimOut.mat'; % Input SimOut filename or ''
VideoOutFname   = './Cruise_Climb_Turn_traj_L1.avi'; % Desired filename of output video
...
% *************************
% NOTE:  Color of arrow in sim refers to a positive or negative change in
% each propeller's thrust output.  Red if the prop's thrust is increasing,
% blue if it's decreasing, and green if even/no change.  Check out
% PropellerClass in build_Lift_plus_Cruise for more details.
